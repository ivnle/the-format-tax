"""LaTeX format backed by vendored source grammars."""

from functools import lru_cache
from pathlib import Path
from typing import Callable, Optional

from extraction import extract_first_matching_lark_answer
...
ANSWER_PATHS = {
    "math500": ["document", "body", "response", "answer", "text"],
    "gpqa": ["document", "body", "response", "answer"],
    "zebralogic": ["document", "body", "response", "answer"],
}
...
def load_grammar(task_name: str) -> str:
    path = _GRAMMARS_DIR / task_name / "latex.lark"
